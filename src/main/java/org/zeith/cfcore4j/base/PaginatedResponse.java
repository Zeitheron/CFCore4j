...
public abstract class PaginatedResponse<V, R extends PaginatedResponse<V, R>>
{
	...
	public Iterator<V> iterateTillEnd()
	{
		...
		{
			private volatile long i = pagination.index;
			private volatile PaginatedResponse<V, R> currentPage = PaginatedResponse.this;
			...
			{
				// get the element from current page, then increment (i++ - get & increment)
